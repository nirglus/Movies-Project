  ...
  fetch(`https://api.themoviedb.org/3/movie/popular?language=en-US&page=${page}&api_key=38aa22b0b8ec6f9efab4ea43ec7c4adc`)
    ...
    .then(data => {
      ...
      moviesArr.forEach((element, index) => {
        ...
        <div class="card-body d-flex flex-column justify-content-end rounded-bottom">
        <h5 class="card-title mb-auto"><a href="../html/single-movie.html?id=${element.id}">${element.original_title}</a></h5>
